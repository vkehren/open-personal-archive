...
export const getListOfUsers = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<Array<IUserDisplayModel>>(request, moduleNameGetter, getListOfUsers_FunctionName, async (request, callState) => {
...
export const getUserAccountDisplayModel = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserAccountDisplayModel>(request, moduleNameGetter, getUserAccountDisplayModel_FunctionName, async (request, callState) => {
...
export const initializeUserAccount = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, initializeUserAccount_FunctionName, async (request, callState) => {
...
export const updateUserProfile = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, updateUserProfile_FunctionName, async (request, callState) => {
    const data = request.data;
...
export const assignUserToRole = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, assignUserToRole_FunctionName, async (request, callState) => {
    const data = request.data;
...
export const addRequestedCitationToUser = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, addRequestedCitationToUser_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const addViewableCitationToUser = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, addViewableCitationToUser_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
    const citationId = (data.citationId) ? data.citationId : undefined;
...
export const setUserToViewed = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToViewed_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const setUserToApprovalState = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToApprovalState_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const setUserToApproved = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToApproved_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const setUserToDenied = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToDenied_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const setUserToSuspensionState = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToSuspensionState_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const setUserToSuspended = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToSuspended_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
    const reason = (data.reason) ? data.reason : "";
...
export const setUserToUnSuspended = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, setUserToUnSuspended_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
    const reason = (data.reason) ? data.reason : "";
...
export const markUserWithDeletionState = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, markUserWithDeletionState_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const markUserAsDeleted = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, markUserAsDeleted_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
...
export const markUserAsUnDeleted = onCall(OPA.FIREBASE_DEFAULT_OPTIONS, async (request) => {
  const result = (await UTL.performAuthenticatedActionWithResult<IUserDisplayModel>(request, moduleNameGetter, markUserAsUnDeleted_FunctionName, async (request, callState) => {
    const data = request.data;
    const userId = (data.userId) ? data.userId : undefined;
