 ...
 */
export function areUpdatesValid(document: ILocale, updateObject: ILocalePartial, throwErrorOnInvalidUpdate = false): boolean {
  ...
  if (!OPA.areUpdatesValid_ForDocument(document, updateObject_AsUnknown as OPA.IDocument, ILocale_ReadOnlyPropertyNames, throwErrorOnInvalidUpdate)) {
