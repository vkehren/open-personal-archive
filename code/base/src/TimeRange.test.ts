...
export const Timestamp_MIN = new firestore.Timestamp(TR.Timestamp_Seconds_MIN, TR.Timestamp_Nanoseconds_MIN);
export const Timestamp_MAX = new firestore.Timestamp(TR.Timestamp_Seconds_MAX, TR.Timestamp_Nanoseconds_MAX);
