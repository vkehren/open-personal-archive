...
export const Timestamp_MIN = new firestore.Timestamp(TR.MIN_TIMESTAMP_SECONDS, TR.MIN_TIMESTAMP_NANOSECONDS);
export const Timestamp_MAX = new firestore.Timestamp(TR.MAX_TIMESTAMP_SECONDS, TR.MAX_TIMESTAMP_NANOSECONDS);
export const Timestamp_Early = firestore.Timestamp.fromDate(Date_Early);
export const Timestamp_Middle = firestore.Timestamp.fromDate(Date_Middle);
export const Timestamp_Late = firestore.Timestamp.fromDate(Date_Late);
