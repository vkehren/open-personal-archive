...
describe("ActivityLog Tests using Firebase " + config.testEnvironment, function() {
  ...
  const testFunc1 = (authState: OPA.DefaultFunc<TestConfig.IAuthenticationStateForTests | null>) => (async () => {
    ...
    const webLogItem0 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes.web_page_view, localhost, resource0, null, {}, null);
    ...
    const serverLogItem0 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes._server_function_call, localhost, resource0, null, {}, null);
    expect(serverLogItem0).not.equals(null);
    expect(serverLogItem0.id).not.equals(null);
    expect(serverLogItem0.activityType).equals(OpaDm.ActivityTypes._server_function_call);
    ...
    const webLogItem1 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes.web_page_view, localhost, resource1, null, {}, null);
    ...
    const serverLogItem1 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes._server_function_call, localhost, resource1, null, {}, null);
    expect(serverLogItem1).not.equals(null);
    expect(serverLogItem1.id).not.equals(null);
    expect(serverLogItem1.activityType).equals(OpaDm.ActivityTypes._server_function_call);
    ...
    const webLogItem2 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes.web_page_view, localhost, resource2, null, {}, null);
    ...
    const serverLogItem2 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes._server_function_call, localhost, resource2, null, {}, null);
    expect(serverLogItem2).not.equals(null);
    expect(serverLogItem2.id).not.equals(null);
    expect(serverLogItem2.activityType).equals(OpaDm.ActivityTypes._server_function_call);
    ...
    const webLogItem3 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes.web_page_view, localhost, resource3, null, {}, null);
    ...
    const serverLogItem3 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes._server_function_call, localhost, resource3, null, {}, null);
    expect(serverLogItem3).not.equals(null);
    expect(serverLogItem3.id).not.equals(null);
    expect(serverLogItem3.activityType).equals(OpaDm.ActivityTypes._server_function_call);
    ...
    const webLogItem4 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes.web_page_view, localhost, resource4, null, {}, null);
    ...
    const serverLogItem4 = await ActivityLog.recordLogItem(config.dataStorageState, authState(), OpaDm.ActivityTypes._server_function_call, localhost, resource4, null, {}, null);
    expect(serverLogItem4).not.equals(null);
    expect(serverLogItem4.id).not.equals(null);
    expect(serverLogItem4.activityType).equals(OpaDm.ActivityTypes._server_function_call);
